...
class Controller
{
    ...
    // Application data
    // These data will be set by the Symfony Jaxon library when registering the controller
    public $view = null;
    public $sfJaxon = null; // Symfony Jaxon bundle
    ...
    public function controller($name)
    {
        ...
        return (($this->sfJaxon) ? $this->sfJaxon->controller($name) : null);
    }
}
